                          ...
                          <div id="fiche_1row">                      
                            <div class="form-group">
                                ...
                                <div class="col-md-12 p-0">
                                    <select class="selectpicker form-control" id="employee_affect" name="employee_affect" style="margin-bottom:8px" multiple aria-label="select">
                                        <option value="" disabled>Selectionner des employées</option>
                                        <?php
                                            global $conn;
                      ...
                      <form id="update_tache_form" autocomplete="off" class="form-horizontal form-material">
                          ...
                          <div id="fiche_1row">                      
                            <div class="form-group">
                                <label class="col-md-12 p-0">Employées<span class="text-danger">*</span></label>
                                <div class="col-md-12 p-0">
                                    <select class="selectpicker form-control" id="up_employee_affect" name="up_employee_affect" style="margin-bottom:8px" multiple aria-label="select">
                                        <option value="" disabled>Selectionner des employées</option>
                                        <?php
                                            global $conn;
                                            $resultat = mysqli_query($conn,"SELECT * FROM user Where id_role='1' and etat_user='1' ORDER BY etat_user ASC");  
